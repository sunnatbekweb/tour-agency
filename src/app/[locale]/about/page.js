		...
		<>
				...
				<div className="container px-6">
					...
					<div className="flex flex-col gap-y-12 lg:flex-row gap-x-5 font-medium text-[#323232]">
						...
						<div className="w-full lg:w-1/2">
							...
							<p className="text-xs md:text-lg lg:text-xl mt-8 lg:mt-25 mb-8 lg:mb-18">
			...
			<section className="bg-[#F0E6E0] pt-20 pb-30">
				<div className="container px-6">
					...
					<h3 className="font-medium text-xl md:text-3xl lg:text-5xl w-full lg:w-1/2 uppercase mb-18">
			...
			<section className="question my-16 md:my-23.5 xl:my-25">
				<div className="container question__container w-full flex flex-col justify-center items-start gap-10 px-6 md:gap-23.5 md:px-9">
