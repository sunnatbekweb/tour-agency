            ...
            <footer
                ...
                <div className="container w-full footerSmSection__container flex flex-col justify-center items-center px-6">
                    ...
                    <div className='footerSmSection__icon-box flex flex-row justify-center items-center gap-[70px] mt-[58px]'>
                        {icon.map((icons, id) => (
                            <div
                                className="footerSmSection__icon-mini-boxes"
                                key={id}>
                                <a className='footerSmSection__icon-links'
                                    href={icons.links}
                                    target="_blank"
                                    rel="noopener noreferrer">
                                    <img className='footerSmSection__icon-images object-cover inline-block w-[48px] h-[48px]'
                                        src={icons.icons}
