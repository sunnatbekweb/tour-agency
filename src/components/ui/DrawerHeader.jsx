    ...
    return (
        ...
        `}> 
            <div className="drawerHeader__top-box flex justify-between items-center px-6 md:px-14">
                ...
                <Link href="/">
                    <img className="drawerHeader__mini-logo w-[67px] h-[37px] md:w-[140px] md:h-[77px]" src="/icons/logo.svg" alt="logo" />
                </Link>
                ...
                <ul className="drawerHeader__list w-full flex flex-col items-center">
                    <li className="drawerHeader__lists w-full text-center">
                        <Link className="drawerHeader__links w-full block" href="/">
                            <p className="drawerHeader__links-texts text-white text-[20px] uppercase font-medium py-[32px] md:text-[32px] md:py-[46px]">Home</p>
                        </Link>
                    ...
                    <li className="drawerHeader__button-list w-full text-center">
                        ...
                        <button className="drawerHeader__button w-full" onClick={toggleDestinations}>
                            <p className="drawerHeader__button-text text-white text-[20px] uppercase font-medium py-[32px] md:text-[32px] md:py-[46px]">Destinations</p>
                        </button>
                        <div
                            className={`
                        ...
                        >
                            <hr className="drawerHeader__hr w-full bg-white opacity-20 border-none outline-none h-[1px]" />
                            <ul className="drawerHeader__second-list flex flex-col gap-2 mt-2 bg-[#AC9D94]">
            ...
            <div className="drawerHeader__contact-button mt-8 flex justify-center items-center md:mt-[46px]">
