	...
	return (
		<div className="hidden md:block xl:hidden">
			<ToastContainer
				...
				transition={Slide}
			/>
			<div className="relative top-22.5 z-[-1]">
				<MdRoadSection />
			</div>
			<footer className="footerMdSection md:w-full md:bg-[#A98D7D] md:rounded-tr-[56px] md:rounded-tl-[56px] md:py-10.5 px-6">
				<div className="container footerMdSection__container md:w-full md:flex md:flex-col md:justify-center md:items-center md:px-9">
					<div className="footerMdSection__top-box md:w-full md:flex md:flex-row md:justify-between md:items-end md:gap-11.75 md:mb-14">
						<div className="footerMdSection__top-left-box md:flex md:flex-col md:justify-center md:items-start md:gap-8">
							<Link href={'/'}>
								<Image
									className="footerMdSection__top-logo inline-block md:w-35 md:h-19.25"
									src={'/icons/logo.svg'}
									width={140}
									height={77}
									alt="logo"
                  loading='lazy'
							...
							<p className="footerMdSection__top-text md:w-58.75 md:font-medium md:text-[24px] md:leading-7.5 md:tracking-tighter-[-2%] md:text-white">
								{t('footer.email_text')}
							</p>
						</div>
						<form
						...
						>
							<div className="footerMdSection__form-box md:w-full md:flex md:flex-col md:justify-items-center md:items-start md:gap-3 md:h-29">
								<div
								...
								>
									<input
										className="footerMdSection__form-email-input md:font-medium md:text-[24px] md:leading-5 md:text-[#323232] md:outline-none"
										onChange={e => {
											e.preventDefault()
										...
										required
									/>
									<button className="footerMdSection__form-button md:flex md:justify-center md:items-center md:absolute md:rounded-[36px] md:px-5.5 md:py-4.75 md:top-2.25 md:bottom-2.25 md:right-2.25 md:bg-[#A98D7D]">
										<Image
					...
					<div className="footerMdSection__middle-box md:w-full md:flex md:flex-row md:justify-between md:items-center">
						...
						>
							<Image
								className="footerMdSection__button-icon md:rotate-316 md:object-cover md:inline-block md:w-20 md:h-20"
                ...
                loading='lazy'
						...
						<div className="footerMdSection__bottom-right-box md:w-69.25 md:flex md:flex-col md:justify-center md:items-center">
							<h4 className="footerMdSection__bottom-right-box-title md:w-69.25 md:font-medium md:text-[35px] md:leading-[100%] md:tracking-tighter-[-2%] md:mb-[57.5px] md:text-white">
								{t('footer.why_travel_title')}
							</h4>
							<q className="footerMdSection__bottom-right-box-texts md:w-69.25 md:mb-[57.5px] md:text-white/70">
							...
							<div className="footerMdSection__icon-box md:w-full md:flex md:flex-row md:justify-between md:items-center">
								{icon.map((icons, id) => (
									...
									>
										...
										>
											<img
												className="footerMdSection__icon-images md:object-cover md:inline-block md:w-16 md:h-16 md:active:duration-100 md:duration-100 md:active:opacity-50"
												src={icons.icons}
					...
					<hr className="footerMdSection__hr md:border-none md:outline-none md:bg-white/15 md:w-full md:h-0.5 md:my-13" />
