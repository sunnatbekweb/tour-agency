        ...
        <div className="container fifthCivilization__container w-full flex flex-col justify-center items-start px-6 gap-8 md:px-9 xl:gap-[56px]">
          ...
          <div className="fifthCivilization__bottom-box w-full flex flex-col justify-center items-start bg-[#E5DFDC] rounded-[10px] py-[23px] px-4 md:px-[24px] md:py-[24px] md:rounded-[24px] xl:px-[48px] xl:py-[48px] 2xl:flex 2xl:flex-row 2xl:justify-between 2xl:gap-[50px] 2xl:items-start 2xl:px-[32px] 2xl:py-[32px] 2xl:h-full">
            <div className="">
              ...
              <p className="fifthCivilization__bottom-second-text w-full w-full text-[#878787] text-[14px] font-medium leading-[18px] mb-8 md:text-[24px] md:leading-[32px] md:mb-20 2xl:text-[24px] 2xl:leading-[32px] 2xl:mb-0 2xl:w-[550px]">
                {t(
