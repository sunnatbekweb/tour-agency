...
export default function FifthFilterSection() {
  const countryData = [
    ...
    },
    {
      id: 2,
      title: "Ahal",
      text: `Ahal Region is a central province of Turkmenistan surrounding the capital, Ashgabat. It is known for its deserts and mountains, including part of the Kopet Dag range. The region is important for agriculture and energy production. It has several historical sites and is a key economic area in the country.`,
      images: "/images/ahal.jpg",
      description: "city__images",
    },
    {
      id: 3,
  ...
  return (
    <section className="fifthFilter w-full mt-[56px] md:mt-[100px]">
      <div className="container fifthFilter__container">
        <div className="fifthFilter__top-box flex flex-row justify-start items-center gap-2 overflow-x-auto mb-[35px] px-6 md:px-9 md:gap-4 md:mb-[50px]">
          {countryData.map((item) => (
            <button
              ...
              className={`fifthFilter__top-buttons w-full transition-all duration-500 ease-in-out flex justify-center items-center px-[22px] py-[10px] rounded-[16px] font-medium text-[16px] leading-[100%] md:text-[32px] md:px-[25px] md:py-[17px] md:rounded-[32px]
              ${
        ...
        <div className="fifthFilter__bottom-box px-6 md:px-9">
