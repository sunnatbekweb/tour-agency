  ...
  const countryData = [
    {
      ...
      images: "/images/samarkand__city.png",
  ...
  return (
    <section className="filter w-full mt-[56px] md:mt-[100px]">
      <div className="container filter__container">
        <div className="filter__top-box flex flex-row justify-start items-center gap-2 overflow-x-auto mb-12 px-6 md:px-9 md:gap-4 md:mb-[88px]">
        ...
        <div className="filter__bottom-box px-6 md:px-9">
          <div className="filter__bottom-card flex flex-col justify-center items-start shadow-xl rounded-[14px] bg-white px-3.5 pt-3.5 pb-[44px] border-[1px] border-[#E5E5E5] md:px-6 md:rounded-[16px]">
            <img
              src={selectedCountry.images}
              alt={selectedCountry.description}
              className="filter__bottom-card-image w-full rounded-[14px] relative bottom-[30px] h-[230px] object-cover md:h-[428px] md:bottom-[46px] md:rounded-[16px] lg:h-[598px] lg:bottom-[72px]"
            />
            <h4 className="filter__bottom-card-title font-medium text-[27px] leading-[100%] mb-3.5 text-[#333333] md:text-[32px] md:mb-5">
