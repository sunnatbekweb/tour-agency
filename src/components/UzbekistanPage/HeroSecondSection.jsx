    ...
    <div>
      <section className="heroSecond">
        <div className="w-full h-screen relative flex flex-col items-center justify-center px-6">
          ...
          <p className="heroSecond__text font-medium uppercase sm:normal-case w-full text-xl tracking-tighter-[-2%] text-white mb-[101px] text-center sm:w-3/4 md:w-[60%] lg:w-[45%] xl:w-full md:text-4xl md:mb-[168px] lg:mb-[268px] xl:text-[42px] xl:mb-[50px]">
            {subtitle}
          </p>
