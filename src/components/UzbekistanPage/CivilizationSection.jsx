  ...
  return (
    <div>
      <section className="civilization mt-10 md:mt-[64px] xl:mt-[100px]">
        <div className="container civilization__container w-full flex flex-col justify-center items-start px-6 gap-8 md:px-9 xl:gap-[56px]">
          ...
          <div className="civilization__bottom-box w-full flex flex-col justify-center items-start bg-[#E5DFDC] rounded-[10px] py-[23px] px-4 md:px-[24px] md:py-[24px] md:rounded-[24px] xl:px-[48px] xl:py-[48px] 2xl:flex 2xl:flex-row 2xl:justify-between 2xl:gap-[50px] 2xl:items-start 2xl:px-[32px] 2xl:py-[32px] 2xl:h-full">
            <div className="">
              <h4 className="civilization__bottom-title text-[#323232] font-medium text-[22px] leading-[100%] mb-3 md:text-[40px] md:leading-[100%] md:mb-[42px]">
                {t(
                  "destinations.uzbekistan.uzbekistan__civilization.civilization__bottom-title"
                )}
              </h4>
              <p className="civilization__bottom-text w-full text-[#878787] text-[14px] font-medium leading-[18px] mb-6 md:text-[24px] md:leading-[32px] md:mb-10 2xl:mb-[30px] 2xl:text-[24px] 2xl:leading-[32px] 2xl:w-[550px]">
                {t(
                  "destinations.uzbekistan.uzbekistan__civilization.civilization__bottom-text"
                )}
              </p>
              <p className="civilization__bottom-second-text w-full text-[#878787] text-[14px] font-medium leading-[18px] mb-8 md:text-[24px] md:leading-[32px] md:mb-20 2xl:text-[24px] 2xl:leading-[32px] 2xl:mb-0 2xl:w-[550px]">
                {t(
