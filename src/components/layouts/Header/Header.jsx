    ...
    <div>
      <header
        className={`header fixed top-0 w-full z-[1111] ${
          isScrolled ? 'backdrop-blur-2xl shadow-2xl duration-500 bg-black/40' : 'duration-500'
        }`}
      >
              ...
              <ul className="header__middle-list">
                <li className="header__middle-lists relative group">
                  ...
                  >
                    ...
                    >
                      {destinations.find((destination) => destination.path === cleanPath)?.label ??
                        'Destinations'}
                    </p>
                  </div>
                    ...
                    >
                      ...
                      <p
                        className={`header__middle-links-texts font-bold uppercase ${
                          cleanPath === item.path ? 'text-[#656267]' : 'text-white'
