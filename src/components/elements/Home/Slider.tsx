		...
		<>
			...
			>
				{[...Array(8)].map((_, index) => (
					<SwiperSlide
						key={index}
						className="w-155 p-3 md:p-5 bg-white border border-[#EBEBEB] shadow rounded-4xl"
					>
						...
						<div className="pt-5">
							...
							<p className="text-lg md:text-3xl mt-3 md:mt-6 mb-5 md:mb-8">
								$456.99
							</p>
