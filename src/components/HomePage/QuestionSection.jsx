...
export default function QuestionSection() {
    ...
    const toggleAnswer = (id) => { setActiveId(prev => (prev === id ? null : id)) }
        ...
        <section className='question mt-[64px] md:mt-[94px] xl:mt-[100px]'>
            <div className="container question__container w-full flex flex-col justify-center items-start gap-[40px] px-6 md:gap-[94px] md:px-9">
                <div className="question__top-box flex flex-col justify-center items-start gap-2 md:gap-4">
                    ...
                    <h2 className='question__title hidden md:block md:font-medium md:text-[56px] md:leading-[100%] md:uppercase md:text-[#323232]'>
                        Need Help Before You Go?
                        <span className='question__title-span md:block'>
                            we’ve got answers
                        </span>
                    </h2>
                    ...
                    <h2 className='question__second-title font-medium text-[32px] leading-[40px] uppercase text-[#323232] md:hidden'>
                        frequently
                        <span className='question__second-title-span block'>
                            asked question
                        </span>
                    </h2>
                </div>
                    ...
                    <div className='question__right-box w-full flex flex-col justify-center items-center gap-2 md:gap-4 xl:flex xl:flex-col xl:justify-center xl:items-end'>
                        {data.map((item, index) => (
                            ...
                            >
                                ...
                                >
                                    <p className='question__right-text text-[12px] leading-[16px] md:text-[24px] md:leading-[32px] md:w-full lg:w-full'>{item.text}</p>
                                </div>
                            </div>
                        ))}
                    </div>
