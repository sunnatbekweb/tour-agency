...
export default function ThirdGallerySection() {
  ...
  return (
    <section className="thirdGallery mt-[64px] md:mt-[120px]">
      <div className="container thirdGallery__container w-full flex flex-col justify-center items-start gap-10 px-6 md:px-9 md:gap-[56px] lg:gap-[51px]">
        <div className="thirdGallery__top flex flex-col justify-center items-start gap-2 md:gap-4">
          <p className="thirdGallery__top-text font-medium text-[16px] leading-[100%] uppercase text-[#A5958B] md:text-[24px]">
            Trip founder
          </p>
          <h2 className="thirdGallery__top-title font-medium text-[32px] leading-[40px] uppercase text-[#323232] w-[170px] md:w-full md:text-[56px]">
